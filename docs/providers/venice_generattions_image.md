    ...
    SimpleGenerateImageRequest:
      ...
      properties:
        background:
          ...
          default: auto
          description: >-
            This parameter is not used in Venice image generation but is
        ...
        model:
          ...
          default: default
          description: >-
            The model to use for image generation. Defaults to Venice's default
        ...
        moderation:
          ...
          default: auto
          description: >-
            auto enables safe venice mode which will blur out adult content. low
            disables safe venice mode.
          example: auto
        'n':
          type: integer
          nullable: true
          ...
          default: 1
          description: >-
            Number of images to generate. Venice presently only supports 1 image
            per request.
          example: 1
        output_compression:
          type: integer
